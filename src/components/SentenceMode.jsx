            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                    ...
                    {userProfile?.tier === 'premium' ? (
                        <div className="flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-amber-500 to-yellow-400 text-black rounded-full shadow-lg shadow-amber-900/20 border border-yellow-300 transform hover:scale-105 transition-transform cursor-default">
